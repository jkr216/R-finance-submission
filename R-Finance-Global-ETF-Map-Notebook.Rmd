...
Take a peek at the dataframe portion of the shapefile and find some interesting nuggets like GDP estimates and economic development stages. It’s nice that the shapefile contains  economic data for us. The other portion of the shapefile is the spatial data: longitude and latitude coordinates. If you’re not a cartographer, don’t worry about those.
